// TUTORIAL
// http://greensock.com/forums/topic/13594-greensock-tweens-in-angularjs/?p=59314
...
export class BlobMorpher implements OnInit {
  ...
  ngOnInit() {
    ...
    this.timeline
      .to(path, 2, { morphSVG: this.path2, x: 120, ease: Power4.easeInOut }, 0)
